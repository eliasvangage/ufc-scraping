...
import { Swords, Home, Users, Calendar, Menu, Flame } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <div className="transition-all duration-300 group-hover:translate-x-1">
              ...
              <p className="text-sm text-muted-foreground -mt-1 font-medium group-hover:text-primary/80 transition-colors duration-300">
              ...
              return (
                <Button
                  ...
                  className={`
                    ...
                    ${
                      isActive ? "border-primary/30" : "hover:border-primary/20"
                    }
                  `}
                >
                  {isActive && (
          ...
          <div className="hidden lg:block">
            <div className="relative">
              <Badge
                variant="outline"
                className="border-green-500/40 text-green-400 px-4 py-2 bg-gradient-to-r from-green-500/10 to-green-500/5 shadow-lg shadow-green-500/10 transition-all duration-300 hover:shadow-green-500/20 hover:scale-105"
              >
