...
export default function EventDetail() {
  ...
  const getFightClassification = (
    ...
    const isPrelims =
      fight.bout_order > 5 && fight.bout_order <= Math.min(9, totalFights);
  ...
  const FighterStatsCard = ({
    ...
    const fighterData =
      prediction?.[corner === "red" ? "fighter1_data" : "fighter2_data"];
    const lastResults =
      prediction?.[corner === "red" ? "fighter1_last5" : "fighter2_last5"] ||
      [];
    ...
    return (
      <Card
        className={`bg-gradient-to-br ${cornerColors[corner].bg} ${cornerColors[corner].border} ${cornerColors[corner].glow} shadow-lg transition-all duration-500 hover:shadow-2xl hover:scale-[1.02]`}
      >
        <CardContent className="p-6 space-y-4">
          ...
          <div className="text-center space-y-2">
            ...
            {fighterData && (
              <div className="flex justify-center gap-2 mt-2">
                <Badge
                  variant="secondary"
                  className="bg-red-500/20 text-red-400 font-semibold"
                >
                  {fighterData.ko_pct}% KO/TKO
                </Badge>
                <Badge
                  variant="secondary"
                  className="bg-yellow-500/20 text-yellow-500 font-semibold"
                >
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-semibold text-center text-muted-foreground tracking-wider">
              OCTAGON METRICS
            </h4>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span
                    className={`font-bold ${corner === "red" ? "text-red-400" : "text-blue-400"}`}
                  >
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="text-center space-y-1">
                  ...
                  <div
                    className={`font-bold text-sm ${corner === "red" ? "text-red-400" : "text-blue-400"}`}
                  >
            ...
            <div className="border-t border-border/30 pt-3">
              <div className="text-xs text-muted-foreground text-center mb-2 tracking-wider">
                PHYSICAL EDGE
              </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="space-y-8">
          ...
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-6 mt-4">
              ...
              >
                ...
                {eventData.fights.filter((f) => f.is_title_fight).length ||
                  0}{" "}
                Title Fights
              </Badge>
              <Badge
                variant="outline"
                className="border-muted/30 text-muted-foreground px-4 py-2"
              >
            ...
            <div className="text-center mb-12">
              <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 rounded-xl p-6 border border-primary/20 mb-8 max-w-2xl mx-auto">
                ...
                <p className="text-muted-foreground mb-4">
                  Generate comprehensive predictions for all fights using
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    for (const fight of eventData.fights) {
                      console.log(
                        `🔄 Predicting: ${fight.fighter_red} vs ${fight.fighter_blue}`,
                      );
                      setAnalyzingFights((prev) =>
                        new Set(prev).add(fight.bout_order),
                      );
                      ...
                      try {
                        ...
                        setPredictions((prev) =>
                          new Map(prev).set(fight.bout_order, prediction),
                        );
                    ...
                    console.log(
                      "📤 Submitting all logs to backend:",
                      predictionLogs,
                    );
          ...
          {eventData.fights.map((fight, index) => {
            ...
            const fightStats = getFightClassification(
              fight,
              eventData.fights.length,
            );

            // Check if this is the first prelims fight to add divider
            const isFirstPrelimsFight =
              fightStats.isPrelims &&
              (index === 0 ||
                !getFightClassification(
                  eventData.fights[index - 1],
                  eventData.fights.length,
                ).isPrelims);

            // Check if this is the first early prelims fight to add divider
            const isFirstEarlyPrelimsFight =
              fightStats.isEarlyPrelims &&
              (index === 0 ||
                !getFightClassification(
                  eventData.fights[index - 1],
                  eventData.fights.length,
                ...
                >
                  <CardHeader className="space-y-4 relative overflow-hidden">
                    ...
                    <div className="relative flex flex-wrap items-center justify-center gap-3">
                      ...
                      <Badge
                        variant="secondary"
                        className="font-medium bg-gradient-to-r from-muted/80 to-muted/60 border-muted/40 text-foreground"
                      >
                      ...
                      <div className="flex flex-col items-center justify-center gap-4">
                        ...
                        <div className="flex items-center justify-center gap-6">
                          ...
                          <div className="flex items-center gap-3 relative">
                            <div className="font-bold text-muted-foreground text-lg animate-pulse">
                              VS
                            </div>
                          </div>
                          <div className="text-center">
                          ...
                          <div className="space-y-8">
                            <div className="text-center relative">
                              ...
                              <div className="relative p-6">
                                ...
                                <p className="text-muted-foreground text-lg">
                                  Complete statistical analysis and recent form
                                </p>
                              </div>
                            </div>
                              ...
                              {isAnalyzing && (
                                <div className="text-center py-8">
                                  ...
                                  <p className="text-muted-foreground">
                                    Analyzing fighter data and generating
                                    prediction...
                                  </p>
                                </div>
                              )}
